    ...
    <>
      ...
      <section className="section__container class__container">
        ...
        <div className="class__image">
          ...
          <img src={estrutura2} alt="Academia equipada para treino com pesos e condicionamento físico" loading="lazy" className="class__img-1" />
          <img src={class2} alt="Aluno treinando na academia" loading="lazy" className="class__img-2" />
        </div>
        <div className="class__content">
          ...
          <a href="https://wa.me/5541996927137?text=Ol%C3%A1!%20Vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20treinos%20da%20academia." target="_blank" rel="noopener noreferrer">
