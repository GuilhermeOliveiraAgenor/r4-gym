  ...
  return (
    ...
    <section className="review">
        <div className="section__container review__container">
          <span><i className="ri-chat-quote-line"></i></span>
          <div className="review__content">
            <h4>MEMBER REVIEW</h4>
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Culpa, nihil, totam ea sit doloribus libero, quos earum
              iure consequatur in quas enim ad a vitae quasi nemo rerum expedita non?
            </p>
